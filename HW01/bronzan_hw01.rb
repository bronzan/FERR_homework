...
#
###############################################################################
# This file created by James Bronzan, a ruby neophyte, as part of FERR class
# at GA, May 7, 2013
#
first_name = "James"
last_name = "Bronzan"
...
puts "Welcome to the Secret Number Game!  Get ready to guess my number!"
puts "Created by #{first_name} #{last_name} a.k.a. #{nick_name}"
###############################################################################
